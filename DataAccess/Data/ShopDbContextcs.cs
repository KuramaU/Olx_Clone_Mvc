...
namespace Data
{
    public class ShopDbContextcs: IdentityDbContext<User>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            string con = "Server=tcp:azurebagserver.database.windows.net,1433;Initial Catalog=BagShop_db;Persist Security Info=False;User ID=lubomyr;Password=Qwerty@1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;";
